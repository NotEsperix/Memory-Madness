...
const SOUNDS = {
	SOUND_MAIN_MENU: preload("res://assets/sounds/Skull Game.mp3"),
	SOUND_IN_GAME: preload("res://assets/sounds/Pokémon Emerald - Battle Factory (Hoenn).mp3"),
	SOUND_SUCCESS: preload("res://assets/sounds/sfx_sounds_fanfare3.wav"),
	SOUND_GAME_OVER: preload("res://assets/sounds/sfx_Pokémon Emerald - Level Up!.wav"),
